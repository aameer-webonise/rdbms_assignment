...
create table info_order(order_id varchar(10) primary key,order_cost double,user_id int,date date,FOREIGN KEY (user_id) REFERENCES user(id));


create table t_order(order_id varchar(10),product_id int,FOREIGN KEY (order_id) REFERENCES info_order(order_id),FOREIGN KEY (product_id) REFERENCES product(id));
...
insert into info_price values(1,1000);
insert into info_price values(2,2000);
insert into info_price values(3,1500);
insert into info_price values(4,3000);
insert into info_price values(5,2500);
insert into info_price values(6,5000);
insert into info_price values(7,4000);
